...
const (
	inputRevisionServiceAccountID     = "revision-service-account-id"
	inputRevisionCores                = "revision-cores"
	inputRevisionMemory               = "revision-memory"
	inputRevisionCoreFraction         = "revision-core-fraction"
	inputRevisionConcurrency          = "revision-concurrency"
	inputRevisionImageURL             = "revision-image-url"
	inputRevisionExecutionTimeout     = "revision-execution-timeout"
	inputRevisionWorkingDir           = "revision-working-dir"
	inputRevisionCommands             = "revision-commands"
	inputRevisionArgs                 = "revision-args"
	inputRevisionEnv                  = "revision-env"
	inputRevisionSecrets              = "revision-secrets"
	inputRevisionProvisioned          = "revision-provisioned"
	inputRevisionNetworkID            = "revision-network-id"
	inputRevisionLogOptionsDisabled   = "revision-log-options-disabled"
	inputRevisionLogOptionsLogGroupID = "revision-log-options-log-group-id"
	inputRevisionLogOptionsFolderID   = "revision-log-options-folder-id"
	inputRevisionLogOptionsMinLevel   = "revision-log-options-min-level"
	inputRevisionStorageMounts        = "revision-storage-mounts"
)
